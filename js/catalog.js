...
function renderTopCategoryBar(){
 ...
 const roots=(typeof getParents==='function'?getParents(true):categories.filter(c=>!(c.parentId||c.parent||c.parentExternalId)))
   .filter(c=>!isBlockedCategory(c)&&!isServiceGroup(c));
